import {
  ...
  import { FaInstagram, FaTwitter, FaYoutube, FaDiscord, FaGithub } from 'react-icons/fa';
          ...
          <SimpleGrid
            ...
            <Stack spacing={6} >
              ...
              <Stack direction={'row'} spacing={6}>
                ...
                <SocialButton label={'Discord'} href={'https://discord.com/invite/jEDHUZcD'}>
                  <FaDiscord/>
                </SocialButton>
